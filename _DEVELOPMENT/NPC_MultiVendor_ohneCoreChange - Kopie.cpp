...
class Vendor
{
	...
	public: Vendor() {}	Vendor(int guid, GossipOptionIcon icon, std::string message)
    {
        m_GUID = guid;
        m_Icon = icon;
        m_Message = message;
...
************************************************************************************************** */
class NPC_Special_VendorMulti : public CreatureScript
{
public: NPC_Special_VendorMulti() : CreatureScript("NPC_Special_VendorMulti"){ }
...
class NPC_Special_VendorMulti_season : public CreatureScript
{
public:
    NPC_Special_VendorMulti_season() : CreatureScript("NPC_Special_VendorMulti_season"){ }
...
void AddSC_NPC_Special_VendorMulti()
{
    new NPC_Special_VendorMulti;
	new NPC_Special_VendorMulti_season;
}