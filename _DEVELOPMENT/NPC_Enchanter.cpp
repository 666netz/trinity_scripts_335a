...
void EnchantWithSpell(Player* player, uint32 spell_id, Item* item)
{
	...
	player->CastSpell(*targets, sSpellMgr->GetSpellInfo(spell_id),NULL, TRIGGERED_IGNORE_POWER_AND_REAGENT_COST);
}
...
{
	public:	npc_enchantment() : CreatureScript("npc_enchantment") { }
	...
	void Show1HWeaponMenu(Player* player, Creature* creature)
	{
		...
		{
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Rune of Cinderglacier", GOSSIP_SENDER_MAIN,ENCHANT_WEP_CINDERGLACIER);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Rune of Lichbane", GOSSIP_SENDER_MAIN,ENCHANT_WEP_LICHBANE);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Rune of Razorice", GOSSIP_SENDER_MAIN,ENCHANT_WEP_RAZORICE);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Rune of Spellbreaking", GOSSIP_SENDER_MAIN,ENCHANT_WEP_SPELLBREAKING);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Rune of Swordbreaking", GOSSIP_SENDER_MAIN,ENCHANT_WEP_SWORDBREAKING);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Rune of the Fallen Crusader", GOSSIP_SENDER_MAIN,ENCHANT_WEP_FALLEN_CRUSADER);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Rune of the Nerubian Carapace", GOSSIP_SENDER_MAIN,ENCHANT_WEP_NERUBIAN_CARAPACE);
		}
		if (player->HasSkill(SKILL_ENCHANTING) && player->GetSkillValue(SKILL_ENCHANTING) >= 450)
		{
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Blade Ward", GOSSIP_SENDER_MAIN,ENCHANT_WEP_BLADE_WARD);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Blood Draining", GOSSIP_SENDER_MAIN,ENCHANT_WEP_BLOOD_DRAINING);
		}
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Accuracy -- 25 Hit + 25 Crit", GOSSIP_SENDER_MAIN,ENCHANT_WEP_ACCURACY);
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Black Magic -- 250 Spell Haste Proc", GOSSIP_SENDER_MAIN,ENCHANT_WEP_BLACK_MAGIC);
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Battlemaster -- Chance of heal on hit", GOSSIP_SENDER_MAIN,ENCHANT_WEP_BATTLEMASTER);
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Berserking -- 400 Attack Power Proc", GOSSIP_SENDER_MAIN,ENCHANT_WEP_BERSERKING);
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Exceptional Agility -- 26 Agility", GOSSIP_SENDER_MAIN,ENCHANT_WEP_AGILITY_1H);
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Exceptional Spirit -- 45 Spirit", GOSSIP_SENDER_MAIN,	ENCHANT_WEP_SPIRIT);
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Executioner -- 120 Arm Pen Proc", GOSSIP_SENDER_MAIN,	ENCHANT_WEP_EXECUTIONER);
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Icebreaker -- Fire damage on hit", GOSSIP_SENDER_MAIN,ENCHANT_WEP_ICEBREAKER);
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Lifeward -- Chance of heal on hit", GOSSIP_SENDER_MAIN,ENCHANT_WEP_LIFEWARD);
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Mighty Spellpower -- 63 Spell Power", GOSSIP_SENDER_MAIN,	ENCHANT_WEP_MIGHTY_SPELL_POWER);
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Mongoose -- 120 Agility Proc", GOSSIP_SENDER_MAIN,ENCHANT_WEP_MONGOOSE);
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Superior Potency -- 65 Attack Power", GOSSIP_SENDER_MAIN,	ENCHANT_WEP_POTENCY);
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Titanguard -- 50 Stamina", GOSSIP_SENDER_MAIN,ENCHANT_WEP_TITANGUARD);
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Titanium Weapon Chain -- Less Disarm Time", GOSSIP_SENDER_MAIN,ENCHANT_WEP_TITANIUM_CHAIN);
	...
	void Show2HWeaponMenu(Player* player, Creature* creature)
	{
		...
		if (player->getClass() == CLASS_DEATH_KNIGHT)
		{
			...
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Rune of Lichbane", GOSSIP_SENDER_MAIN,ENCHANT_WEP_LICHBANE);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Rune of Razorice", GOSSIP_SENDER_MAIN,ENCHANT_WEP_RAZORICE);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Rune of Spellshattering", GOSSIP_SENDER_MAIN,	ENCHANT_WEP_SPELLSHATTERING);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Rune of Swordshattering", GOSSIP_SENDER_MAIN,	ENCHANT_WEP_SWORDSHATTERING);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Rune of the Fallen Crusader", GOSSIP_SENDER_MAIN,	ENCHANT_WEP_FALLEN_CRUSADER);
			AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Rune of the Stoneskin Gargoyle", GOSSIP_SENDER_MAIN,ENCHANT_WEP_STONESKIN_GARGOYLE);
		}
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Berserking -- 400 Attack Power Proc", GOSSIP_SENDER_MAIN,	ENCHANT_WEP_BERSERKING);
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Executioner -- 120 Arm Pen Proc", GOSSIP_SENDER_MAIN,ENCHANT_WEP_EXECUTIONER);
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Greater Spellpower -- 81 Spell Power", GOSSIP_SENDER_MAIN,ENCHANT_WEP_GREATER_SPELL_POWER);
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Major Agility -- 35 Agility", GOSSIP_SENDER_MAIN,	ENCHANT_WEP_AGILITY_2H);
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Massacre -- 110 Attack Power", GOSSIP_SENDER_MAIN,ENCHANT_WEP_MASSACRE);
		AddGossipItemFor(player, GOSSIP_ICON_INTERACT_1, "Mongoose --120 Agility Proc", GOSSIP_SENDER_MAIN,	ENCHANT_WEP_MONGOOSE);
		AddGossipItemFor(player, GOSSIP_ICON_CHAT, "Back", GOSSIP_SENDER_MAIN, -1);
		SendGossipMenuFor(player, DEFAULT_GOSSIP_MESSAGE, creature->GetGUID());
	}
